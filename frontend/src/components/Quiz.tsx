  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-sage-50 via-surface to-surface py-8 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        {/* Two-column layout: text left, diagram right (desktop) / stacked (mobile) */}
        <div className="flex flex-col md:flex-row gap-6">
          {/* LEFT: Animated question card (text, options, explanation) */}
          ...
          {/* RIGHT: Persistent diagram (desktop only, stacks below on mobile) */}
