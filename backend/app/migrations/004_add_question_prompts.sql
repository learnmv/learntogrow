-- Migration: Add question_prompts table for admin-editable prompt templates
-- This allows admins to edit LLM prompts through the dashboard without code changes
...
-- Seed initial prompts from existing template files

-- Open-ended question template
INSERT INTO question_prompts (name, content, description) VALUES
('open_ended',
$prompt$Generate a {question_type} math question for Grade {grade_level}.
...
$prompt$,
'Open-ended question template for questions without multiple choice options'),
...
$prompt$,
'Multiple choice question template with 4 options'),

-- GeoGebra diagram question template
('geogebra_diagram',
$prompt$Generate a {question_type} math question for Grade {grade_level} that INCLUDES an interactive GeoGebra diagram.
...
$prompt$,
'Question template for questions requiring GeoGebra diagram visualization');